...
void main()
{
    ...
    vec3 results = CalcDirLight(dirLight, normal, viewDir);
    results += CalcSpotLight(spotLight, normal, FragPos, viewDir);
    results += CalcPointLight(pointLight, normal, FragPos, viewDir);
